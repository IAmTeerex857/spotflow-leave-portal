...
export default function SignupPage() {
  return (
    ...
    >
      ...
      <div className="fade-in" style={{ width: '100%', maxWidth: '420px', display: 'flex', flexDirection: 'column', gap: '28px' }}>
        {/* Logo */}
        <Link href="/" style={{ display: 'flex', alignItems: 'center', gap: '9px', textDecoration: 'none', justifyContent: 'center' }}>
        ...
        <div className="glass-card" style={{ padding: '32px' }}>
          <div style={{ marginBottom: '24px' }}>
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-muted)' }}>
              Join your team on the Leave Portal
            </p>
          </div>
          <SignupForm />
        </div>
